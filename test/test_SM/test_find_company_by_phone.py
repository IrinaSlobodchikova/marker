...
def test_sm_find_company_by_phone_company(app):
    ...
    app.testHelperSMSearch.find_company_by_phone("+7 (3022) 211140")
...
def test_sm_find_company_by_phone_zakazchiki(app):
    app.testhelpersm.refresh_page()
...
def test_sm_find_company_by_phone_poctavchiki(app):
    app.testhelpersm.refresh_page()
